...
public class Options extends Sprite
   {
      ...
      private function addGraphicsOptions() : void
      {
         ...
         this.addOption(new ChoiceOption("uitoggle", new <String>["Custom","Classic"], [true,false], "UiToggle", "Enabling this will switch between UI:s", onUiToggleChange));
      ...
      private function onUiToggleChange():void {
         Parameters.save();

         if (this.gs_ == null) return;
      ...
      private function removeHUDIfPresent():void {
         var map:Map = this.gs_.map;
         if (this.gs_.hudView != null && this.gs_.contains(this.gs_.hudView)) {

            this.gs_.removeChild(this.gs_.hudView);

         }
         if (map.gradientOverlay_ && map.contains(map.gradientOverlay_)) {
      ...
      private function addHUDIfAbsent():void {
         var map:Map = this.gs_.map;
         if (this.gs_.hudView == null || !this.gs_.contains(this.gs_.hudView)) {
